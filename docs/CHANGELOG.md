...
## [0.1.0] - 2026-08-26
### Added
- Added `where` param to generateQuery as normal `WHERE` clause  

- [0.1.1] 2026-08-29  
  - Fixed `tempulator` to use flask lazy-loading  
  - Added actual API routes  
  - Changed `templeton.views` into `templeton.views`, `templeton.api`, `templeton.route`  
  - Added `templeton.decorator`  
  - Added `templeton.decorator.templetonWrapper` decorator for webpage templates.  
  - Added `appFactory()`  
